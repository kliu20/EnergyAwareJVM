 ...
 * <p>
 * Note: Boolean options are defined in /home/kmahmou1/jikes/jikesrvm/rvm/src-generated/options/BooleanOptions.vm.dat
 *       All other options are defined in /home/kmahmou1/jikes/jikesrvm/rvm/src-generated/options/ValueOptions.vm.dat
 *       (value, enumeration)
 * <p>
...
@Uninterruptible public class Options extends Configuration {
   ...
   public static float interruptQuantum                = 4.0f; // Timer interrupt scheduling quantum in ms
  ...
  public static boolean process(String arg) {
	...
	//Kenan
       ...
       interruptQuantum = CommandLineArgs.primitiveParseFloat(value);
       return true;
     }
