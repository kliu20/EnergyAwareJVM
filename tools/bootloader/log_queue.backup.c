...
#define METHOD_ENTRY_PREALLOC 900
...
#define MAX_THREADS 1000
	...
	extern thread_stats *allocate_thread_stats() {
	    ...
	    lstats->timestamps=malloc(sizeof(long) * pre_allocation);
	    check_malloc(lstats->timestamps, "Allocating Timestamps");
	    lstats->cmdids=malloc(sizeof(int)*pre_allocation);
	    ...
	    lstats->frequencies=malloc(sizeof(int)*pre_allocation);
