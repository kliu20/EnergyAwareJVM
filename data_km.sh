...
timeSlice=('0' '4.0' '2.0' '1.0' '0.5' '0.25' '0.125')
...
#				runJikesNoProfile ${freq[$i]} 4 ${timeSlice[$j]} &>> ./kmahmou1/data_${timeSlice[$j]}_slice.csv
#				#break
#			done
#		done
		java energy.Scaler 5 userspace
		runJikesNoProfile ${freq[3]} 4 ${timeSlice[6]} &>> ./kmahmou1/data_${timeSlice[6]}_slice.csv
